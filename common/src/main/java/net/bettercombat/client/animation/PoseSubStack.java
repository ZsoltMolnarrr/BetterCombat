...
public class PoseSubStack extends PlayerAnimationController {
    public PoseSubStack(AbstractClientPlayerEntity player, AnimationStateHandler animationHandler) {
        super(player, animationHandler);
    }

    public PoseSubStack(AbstractClientPlayerEntity player, AnimationStateHandler animationHandler, Function<AnimationController, MochaEngine<AnimationController>> molangRuntime) {
